...
npx skills add vipentti/skills --skill implementation-simplicity # just one
```
...
| [implementation-simplicity](skills/implementation-simplicity/SKILL.md) | implement features, fixes, and refactors with the least machinery needed while preserving correctness |
